...
describe('DEFAULT_CONFIG_SPACE', () => {
  it('correct dimension', () => {
    expect(DEFAULT_CONFIG_SPACE.dimension).toBe(16);
  });
  ...
  it('Thompson sampling around center', () => {
    const samples = DEFAULT_CONFIG_SPACE.sampleThompson(new Float64Array(16).fill(0.5), new Float64Array(16).fill(0.01), 10, () => 0.5);
